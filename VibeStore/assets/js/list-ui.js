      ...
      <div class="modal modal-large">
        ...
        <div class="modal-body">
          ...
          <div class="list-apps-grid-new">
            ${apps.length === 0 ?
              '<div style="text-align: center; padding: 2rem; color: var(--c-muted);"><div style="font-size: 3rem; margin-bottom: 1rem;">📱</div><h4>No apps in this list</h4><p>Add some apps to get started!</p></div>' :
              apps.map(app => `
                <div class="list-app-card-new" onclick="window.location.href='/pages/app?id=${app.appId}'">
                  <div class="list-app-card-icon-new">${app.appIcon || '📱'}</div>
